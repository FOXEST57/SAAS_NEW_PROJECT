...
- voir paiement en fonction du type de paiement choisi (Table de Paiement)
- préfixe pour référence client en fonction de son type de référencement a lui (Son Référencement a lui )
